 ...
 */
qx.Theme.define("aie.theme.metro.Appearance",
{
  appearances :
  {
    /*
    ...
    */
    ...
    "button-frame" :
    {
      ...
      style : function(states)
      {
        ...
        if (states.disabled)
        {
          decorator = "aie-metro-std-button-disabled";
        }
        else if (states.pressed)
        {
          decorator = "aie-metro-std-button-pressed";
        }
        else if (states.checked)
        {
          /*Supports ToggleButton's checked state*/
          decorator = "aie-metro-std-button-checked";
        }
        else if (states.hovered)
        {
          decorator = "aie-metro-std-button-hovered";
        }
        else if (states.focused && !states.inner)
        {
          decorator = "aie-metro-std-button-focused";
        }
        else
        {
          decorator = "aie-metro-std-button-default";
        }
    ...
    "splitbutton/arrow/icon" :
	{
      ...
      style : function(states)
      {
        ...
        return {
          decorator : "aie-metro-selectbox-down-arrow",
          //padding:6,
          paddingRight : 6,
          paddingLeft : 7,
          width: 7,
    ...
    */
    ...
    "list" :
    {
      ...
      style : function(states)
      {
        ...
        return {
          decorator       : states.focused ? "aie-metro-std-list-default" : "aie-metro-std-list-default",
    ...
    */
    ...
    "checkbox/icon" : {
      style : function(states)
      {
        ...
        if (states.checked) {
          if (states.disabled) {
            decorator = "aie-metro-std-checkbox-chkd-disabled";
          } else if (states.pressed) {
            decorator = "aie-metro-std-checkbox-chkd-pressed";
          } else if (states.hovered) {
            decorator = "aie-metro-std-checkbox-chkd-hovered";
          } else {
            decorator = "aie-metro-std-checkbox-chkd";
          }

        // Undetermined
        } else if (states.undetermined && !states.disabled) {
          decorator = "aie-metro-std-checkbox-mixed";
          
        } else if (states.undetermined && states.disabled) {
            decorator = "aie-metro-std-checkbox-mixed-disabled"

        // Focused & Pressed & Hovered (when enabled)
        } else if (!states.disabled) {
            if (states.pressed) {
            decorator = "aie-metro-std-checkbox-pressed";
          } else if (states.hovered ) {
            decorator = "aie-metro-std-checkbox-unchkd-hovered";
          } else {
            decorator = "aie-metro-std-checkbox";
          }
        
        } else if (states.disabled && !states.checked) {
        	decorator = "aie-metro-std-checkbox-disabled";
        }
    ...
    "radiobutton/icon" : {
      style : function(states)
      {
        ...
        if (states.checked) {
          if (states.disabled) {
            decorator = "aie-metro-std-radiobutton-chkd-disabled";
          } else if (states.pressed) {
            decorator = "aie-metro-std-radiobutton-chkd-pressed";
          } else if (states.hovered) {
            decorator = "aie-metro-std-radiobutton-chkd-hovered";
          } else {
            decorator = "aie-metro-std-radiobutton-chkd";
          }

        // Undetermined
        } else if (states.undetermined) {
          decorator = "aie-metro-std-radiobutton-mixed";

        // Focused & Pressed & Hovered (when enabled)
        } else if (!states.disabled) {
            if (states.pressed) {
            decorator = "aie-metro-std-radiobutton-pressed";
          } else if (states.hovered ) {
            decorator = "aie-metro-std-radiobutton-unchkd-hovered";
          } else {
            decorator = "aie-metro-std-radiobutton";
          }
          
        } else if (states.disabled && !states.checked) {
        	decorator = "aie-metro-std-radiobutton-disabled";
        }
    ...
    */
    ...
    "scrollbar/slider" :
    {
      ...
      style : function(states)
      {
        ...
        if (states.vertical) {
        	decorator = "aie-metro-std-scrollbar-vertical";
        } 
        else if (states.horizontal) {
        	decorator = "aie-metro-std-scrollbar-horizontal";
        }
    ...
    "scrollbar/button" :
    {
      ...
      style : function(states)
      {
        ...
        if (states.up || states.down)
	        ...
	        {
	          decorator = "aie-metro-std-scrollbarbuttonup-default";
	        }
    ...
    "scrollbar/button-begin/icon":
    {
      ...
      style : function(states)
      {
        ...
        return {
          decorator: "aie-metro-scrollbarbutton-up-arrow",
          width: 9,
          height: 6,
          alignX: "center"
        }
    ...
    */
    ...
    "window" :
    {
      style : function(states)
      {
        return {
          ...
          backgroundColor : "transparent",
          decorator : "aie-metro-std-window"
    ...
    "window/pane" : 
    {
    	style : function(states)
    	{
    		return {
    			//backgroundColor : "white",
    			decorator : "aie-metro-std-window-pane",
    			marginLeft : 6,
    			marginRight : 6,
    			marginBottom : 6
    		};
    ...
    */
    ...
    "combobox" :
    {
      style : function(states)
      {
        ...
        return {
          decorator       : states.focused ? "aie-metro-std-cbobox-focused" : "aie-metro-std-cbobox-default",
          textColor       : states.disabled ? "text-disabled" : undefined,
          backgroundColor : backgroundColor,
          height: 21
        };
    ...
    "combobox/button/icon":
    {
      ...
      style : function(states)
      {
        ...
        return {
          decorator: "aie-metro-std-cbobutton-default",
          width: 7,
          height: 7,
          alignX: "center"
        }
    ...
    "combobox/button" :
    {
      ...
      style : function(states)
      {
      	...
      	if (states.pressed)
        {
          decorator = "aie-metro-std-cbobutton-pressed";
        }
        else if (states.hovered)
        {
          decorator = "aie-metro-std-cbobutton-hovered";
        }
