  ...
  members :
  {
	...
	{ 
	  ...
	  switch(vS) {
	  	case "default" :
	  		/** Top Left op **/
		  	h_whlt.push([1,1,0,0,131,134,141,120]);
		  	
		  	/** Top Right op **/
		  	h_whrt.push([1,1,0,0,131,134,141,120]);
		  	
		  	/** Top **/
		  	h_hlrt.push([1,2,2,0,131,134,141]);
		  	...
		  	/** Bottom Left op **/
		  	h_whlb.push([1,1,0,0,210,219,229,120]);
		  	
		  	/** Bottom Right op **/
		  	h_whrb.push([1,1,0,0,210,219,229,120]);
			...
			fh_str = fh.concat(
				...
				h_whrt.map(painter1._whrt_op),
				h_wltb.map(painter1._wltb),
				h_wrtb.map(painter1._wrtb),
				h_whlb.map(painter1._whlb_op),
				h_whrb.map(painter1._whrb_op),
